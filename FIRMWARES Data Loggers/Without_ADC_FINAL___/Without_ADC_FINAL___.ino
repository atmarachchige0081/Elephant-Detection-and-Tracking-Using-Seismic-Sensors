...
const int sampleInterval = 4000;  // in microseconds
...
void loop() {
    ...
    if (currentTime - lastSampleTime >= sampleInterval) {
        ...
        char timeString[64];
        unsigned long millisPart = (currentTime / 1000) % 1000;
        sprintf(timeString, "%02d:%02d:%02d.%03lu", timeinfo.tm_hour, timeinfo.tm_min, timeinfo.tm_sec, millisPart);
